...
public class HomePageLinkTest extends TestBase{
	...
	public void user_will_be_in_the_login_page() {
	   Hp.SignPageTitel();
	   Assert.assertEquals(Hp.SignPageTitel(), "Amazon Sign-In");
	   Hp.BackHOmePage();
	}
	...
	public void user_should_see_all_the_menu() {
	   Hp.AllMenuPAgeTitle();
	   Assert.assertEquals(Hp.AllMenuPAgeTitle(), "Amazon[.com: Online Shopping for Electronics, Apparel, Computers, Books, DVDs & more");
	   Hp.BackHOmePage();
	}
	...
	public void user_should_see_their_desier_product() {
	   ...
	   Assert.assertEquals(Hp.FindDesireProductPageTitel(), "Amazon.com : iphone");
	   Hp.BackHOmePage();
	}
	...
	public void user_should_be_in_the_return_page() {
	  Hp.ReturnPageTitel();
	  Assert.assertEquals(Hp.ReturnPageTitel(), "Amazon Sign-In");
	  Hp.BackHOmePage();
	}
	...
	public void user_should_be_curt_page() {
	   Hp.CurtPageTitel();
	   Assert.assertEquals(Hp.CurtPageTitel(), "Amazon.com Shooping Cart");
	}
}
